...
def _build_prompt(client_request: str, repo_context: Optional[str]) -> str:
    ...
    return (
        ...
        "\n"
        "CLIENT REPLY FORMAT (MANDATORY):\n"
        "The 'clientReply' string MUST follow this exact email structure, using markdown formatting (but escaped properly for JSON):\n"
        "Hello,\n\n"
        "Thank you for your request. I have analyzed the proposed changes and want to ensure we are aligned before starting:\n\n"
        "**My Understanding:**\n"
        "[Brief summary of what they want]\n\n"
        "**Identified Technical Scope:**\n"
        "- [Key technical task 1]\n"
        "- [Key technical task 2]\n\n"
        "**Important Questions Before Starting:**\n"
        "1. [Question 1]\n"
        "2. [Question 2]\n\n"
        "**Estimation:** [Time Range]\n\n"
        "Would you be available for a quick 15-minute call to clarify these points before development begins?\n\n"
        "Best regards\n"
        "\n"
